...
class Collection{
  ...
  #createUID(){ return ((char,charLen)=>log(new Array(7)).reduce((id)=>log(id+char.charAt(Math.floor(Math.random() * charLen))),this.#__i__++))(this.#__chars__,this.#__chars__.length) }
